...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        searchText->setGeometry(QRect(10, 20, 671, 31));
        searchButton = new QPushButton(centralwidget);
        searchButton->setObjectName(QString::fromUtf8("searchButton"));
        searchButton->setGeometry(QRect(698, 20, 81, 31));
        results = new QPlainTextEdit(centralwidget);
        results->setObjectName(QString::fromUtf8("results"));
        results->setGeometry(QRect(10, 60, 771, 521));
